...
namespace Evergine.MRTK.Demo.Effects
{
    ...
    public class HoloHands : Evergine.Framework.Graphics.MaterialDecorator
    {

        public HoloHands(Evergine.Framework.Graphics.Effects.Effect effect) :
                base(new Material(effect))
        {
        }

        public HoloHands(Evergine.Framework.Graphics.Material material) :
                base(material)
        {
        }
