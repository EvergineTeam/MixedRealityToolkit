...
namespace Evergine.MRTK.Demo.Effects
{
    ...
    public class WireframeHolo : Evergine.Framework.Graphics.MaterialDecorator
    {

        public WireframeHolo(Evergine.Framework.Graphics.Effects.Effect effect) :
                base(new Material(effect))
        {
        }

        public WireframeHolo(Evergine.Framework.Graphics.Material material) :
                base(material)
        {
        }
        ...
        public Evergine.Mathematics.Vector3 Matrices_Color
        {
            get
            {
        ...
        public Evergine.Mathematics.Vector3 Matrices_TPos
        {
            get
            {
